...
internal_functions_features['internal_sprintf']={'name':'internal_sprintf','searchbytes':'5589e5565381ecb40000008b....8d..........c7............c744241000000000c744240c00000000c7..............c7..............891c24e8........8974240c89742404c7............c7..............891c24e8........8b....891c24894424088b....89442404e8........89c68b..........3b..........73..c6000081c4b400000089f05b5e5dc3c744240400000000891c24e8........eb..','startaddr':0x0}
            ...
            for item in re_text.finditer(searchresult):
                ...
                if "xprintf" in fn:
                    ...
                    for itemx in rei_text.finditer(searchresulti):
                        ...
                        ret['0x%s' % fprintfaddr] = 'fprintf'
                        break

                    internal_sprintfaddr = internal_functions_features['internal_sprintf']['startaddr']
                    offset =  '%08x' % (int(internal_sprintfaddr,16)-int(startaddr,16)-0x1f)
                    searchbytes = fndata['searchbytes']
                    searchbytes = list(searchbytes)
                    searchbytes[-5-0] = offset[1]
                    searchbytes[-5-1] = offset[0]
                    ...
                    for itemx in rei_text.finditer(searchresulti):
                        fprintfaddr = item.group(1)
                        ret['0x%s' % fprintfaddr] = '__isoc99_sscanf'
                        break
                else:
                    if fndata['searchbytes'][:2] in item.group(3)[:3]:
...
if __name__ == "__main__":
    known_libc_functions = get_known_libc_functionaddr('/home/wb/Downloads/pwn09')
    print known_libc_functions
    #check 0x080a4fa0 if it's a known functions
    if '0x08049640' in known_libc_functions.keys():
        print 'found known function: %s ' %  known_libc_functions['0x08049640']
    else:
        print 'failed'
